...
class _SignUpContainerState extends State<_SignUpContainer> {
              ...
              Expanded(
                child: SingleChildScrollView(
                  child: Column(
                    mainAxisAlignment: MainAxisAlignment.spaceAround,
                    children: [
                      inputWidget("Input your account", _inputAccountController,
                          false, TextInputType.text),
                      inputWidget("Input password", _inputPasswordController,
                          true, TextInputType.text),
                      inputWidget(
                          "Re-Input password",
                          _inputPassConfirmController,
                          true,
                          TextInputType.text),
                      inputWidget("Input your name", _inputNameController,
                          false, TextInputType.text),
                      inputWidget("Input your phone", _inputPhoneController,
                          false, TextInputType.phone),
                      inputWidget("Input your address", _inputAddressController,
                          false, TextInputType.text),
                      SizedBox(
                        height: 20,
                      ),
  ...
  Widget inputWidget(String hint, TextEditingController textEditingController,
      bool isPwd, TextInputType textInputType) {
    return Container(
  ...
  void handleConfirmBtn() {
    ...
    if (_inputAccountController.text.isEmpty) {
      ...
      if (_inputPassConfirmController.text !=
          _inputPassConfirmController.text) {
        messageErr = "the password is not match!";
      } else {
        bloc.eventSink.add(SignUpEvent(
            email: _inputAccountController.text,
